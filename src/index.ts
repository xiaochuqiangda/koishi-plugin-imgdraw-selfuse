...
export async function apply(ctx: Context, cfg: any) {
   ...
   */
  async function callApi(session: any, prompt: string, imageUrl: string | undefined, api: any, model: string, subModel?: any): Promise<{ success: boolean; result?: any; error?: string; rawError?: any }> {
